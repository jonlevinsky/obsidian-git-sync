...
tags:
  ...
  - spsst-panska
type: project
project: Technologie obrazu
project_tags: to
status: archived
description: 15 lekcí — světlo, TV, komprese, kamera, osvětlení
...
const folder = dv.pages('"Škola/PANSKÁ/Technologie Obrazu"').where(p => p.file.name !== 'Technologie Obrazu.md').sort(p => p.file.name, 'asc');
...
left.createEl('h1', { text: 'TECHNOLOGIE OBRAZU' });
...
s('🖼️', dv.pages('"Škola/PANSKÁ/Technologie Obrazu/Images"').length, 'obrázků');
